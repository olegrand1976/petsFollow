...
| Commercial manager | `commercial.manager@petsfollow.test` | Bérénice — équipe démo forcée au seed : Camille + Alex (2 reps) — multi-profils Pro (tous sauf `admin`) |
| Commercial | `commercial.demo@petsfollow.test` | Camille — vet.demo assigné, 5 prospects Bruxelles, rattaché manager — multi-profils Pro (tous sauf `admin` / `commercial_manager`) |
| Commercial | `commercial.demo2@petsfollow.test` | Alex — vet.parc assigné, 5 prospects Nord, rattaché manager — multi-profils Pro (tous sauf `admin` / `commercial_manager`) |
