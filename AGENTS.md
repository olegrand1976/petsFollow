...
Mot de passe commun véto : `VetDemo123!` · client : `ClientDemo123!` · admin / DEV : `AdminDemo123!` · commercial : `CommercialDemo123!` · care_pro : `CareProDemo123!`
...
**Modules Pro tag `dev`** (badge `nav.tagDev`, pas GA) : facturation `/invoicing` · pharmacie `/medicaments` `/stock` `/daf` (`PHARMACY_ENABLED`) · **prescriptions** `/prescriptions` (`PRESCRIPTIONS_ENABLED`, doc [`35-PRESCRIPTIONS.md`](documentation/35-PRESCRIPTIONS.md)) · **PACS** onglet Imagerie + `/admin/pacs` (`PACS_ENABLED`, doc [`40-PACS.md`](documentation/40-PACS.md) — local : `make up-pacs` + `make pacs-demo-seed`). Règle `.cursor/rules/modules-tag-dev.mdc`.
