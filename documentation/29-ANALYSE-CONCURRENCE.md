...
5. **Angle petsFollow (récurrent)** : **Pro (Web) · Pro Light (mobile) · app client (mobile)** · prescription véto · B2B2C · Pro **834,71 € HTVA/an** (+ setup ; triennal −10 %) · client **3,50 / 35 / 95 €** · Care/Horse inclus · relevés FC en feature · 6 langues (FR/NL/EN/ES/ET/IT).
