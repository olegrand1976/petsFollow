...
Source de vérité : migrations `go/internal/platform/db/migrations/` (000001 → 000030+).
...
Migrations utiles : `000019` commissions · `000020` `commercial_bonus_awards` · `000022` kennel / litter_tag / ledger addon · `000023` addon `stripe_subscription_id` + `past_due` · `000024` calendrier véto · `000026` profil payout véto · `000028`/`000029` import clients.
