...
| C7.22 | P1 | Immutabilité mouvements + preuve 5 ans | Trigger append-only (+ nullify FK/RGPD) ; `GET …/movements/retention-stats` (`immutableEnforced`) | Go `TestPharmacyStockMovementsImmutableAndRetentionStats` ; DAF UI `vamreg-refs` (datalist) |
