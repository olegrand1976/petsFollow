...
| C7.21 | P1 | AFMPS cron gate 1 | `POST /internal/afmps-import/run` : secret + objet média → staging + notif ; skip pending/unchanged ; jamais commit auto | Go `TestInternalAfmpsImportRun*` ; `make gcp-afmps-import-scheduler` |
