...
- Env non secrète : `GEMINI_MODEL` (défaut `gemini-3.7-flash`) et `GEMINI_LITE_MODEL` (défaut `gemini-3.5-flash-lite`, mapping import + analyzer) via `pf_write_api_env_file`
