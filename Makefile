...
nuxtjs-dev: env
	@set -a && source $(ENV_FILE) && set +a && cd nuxtjs && npm install && BFF_PROXY_SECRET=$${BFF_PROXY_SECRET:-dev-bff-proxy-secret} NUXT_PUBLIC_BILLIT_ENABLED=$${NUXT_PUBLIC_BILLIT_ENABLED:-true} NUXT_PUBLIC_PHARMACY_ENABLED=$${NUXT_PUBLIC_PHARMACY_ENABLED:-true} NUXT_PUBLIC_PRESCRIPTIONS_ENABLED=$${NUXT_PUBLIC_PRESCRIPTIONS_ENABLED:-true} NUXT_PUBLIC_EID_ENABLED=$${NUXT_PUBLIC_EID_ENABLED:-true} NUXT_PUBLIC_PACS_ENABLED=$${NUXT_PUBLIC_PACS_ENABLED:-true} NUXT_PUBLIC_RESEARCH_ENABLED=$${NUXT_PUBLIC_RESEARCH_ENABLED:-true} NUXT_PUBLIC_VET_NEWS_ENABLED=$${NUXT_PUBLIC_VET_NEWS_ENABLED:-true} NUXT_PUBLIC_AI_CR_ADVANCED_ENABLED=$${NUXT_PUBLIC_AI_CR_ADVANCED_ENABLED:-true} NUXT_PUBLIC_SITES_UI_ENABLED=$${NUXT_PUBLIC_SITES_UI_ENABLED:-true} npx nuxt dev --port $${PETSFOLLOW_NUXTJS_PORT:-3002} --host 0.0.0.0
