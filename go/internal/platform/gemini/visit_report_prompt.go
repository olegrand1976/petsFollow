...
structuré STRICTEMENT avec ces sections (titres exacts) :
...
N'invente aucun fait absent de la source. Pays d'exercice de référence : %s.`, lang, country)
...
structuré STRICTEMENT avec ces sections (titres exacts, dans cet ordre) :
...
Règles impératives :
- N'invente aucun fait, symptôme, résultat d'examen, diagnostic ou médicament absents de la source.
