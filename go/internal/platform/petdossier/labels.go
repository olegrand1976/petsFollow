...
func labelsFor(locale string) pdfLabels {
	...
	case "nl":
		return pdfLabels{
			...
			HeartRate:        "Ademhalingsfrequentie",
			Alert:            " [alert]",
	...
	case "es":
		return pdfLabels{
			...
			HeartRate:        "Frecuencia respiratoria",
			Alert:            " [alerta]",
	...
	case "it":
		return pdfLabels{
			...
			HeartRate:        "Frequenza respiratoria",
			Alert:            " [allerta]",
	...
	case "uk":
		return pdfLabels{
			Subtitle:         "Картка тварини — тимчасовий доступ (24 год)",
			CTA:              "Фахівець із тварин: приєднайтеся до petsFollow, щоб безперервно спостерігати за пацієнтами.",
			Register:         "Реєстрація: ",
			Offer:            "Тарифи: ",
			ContactTitle:     "Ваш контакт у petsFollow",
			DefaultContact:   "Команда продажу petsFollow",
			Phone:            "Тел.: ",
			Email:            "Email: ",
			Animal:           "Тварина",
			Name:             "Ім'я",
			...
			Weight:           "Вага",
			Chip:             "Мікрочип",
			HealthBook:       "Медична книжка",
			Owner:            "Власник",
			OwnerEmail:       "Email власника",
			RecentWeights:    "Останні вимірювання ваги",
			HeartRate:        "Частота дихання",
			Alert:            " [сповіщення]",
			CareReminders:    "Нагадування про догляд",
			Visits:           "Візити (фахівець)",
			ProConsulted:     "Фахівець: ",
			Timeline:         "Хронологія",
			Attachments:      "Вкладення",
			HealthBookIncl:   "• medychna-knyzhka.pdf (входить у пакет)",
			NoAttachments:    "Вкладень немає.",
			FooterGenerated:  "Створено %s UTC — petsFollow — безперервність ветеринарної допомоги.",
			FooterCreateAcct: "Створити професійний акаунт: ",
			FooterCommercial: "Контакт менеджера з продажу: ",
		}
	case "ru":
		return pdfLabels{
			Subtitle:         "Карта животного — временный доступ (24 ч)",
			CTA:              "Специалист по животным: присоединяйтесь к petsFollow, чтобы непрерывно наблюдать за пациентами.",
			Register:         "Регистрация: ",
			Offer:            "Тарифы: ",
			ContactTitle:     "Ваш контакт в petsFollow",
			DefaultContact:   "Команда продаж petsFollow",
			Phone:            "Тел.: ",
			Email:            "Email: ",
			Animal:           "Животное",
			Name:             "Имя",
			...
			Weight:           "Вес",
			Chip:             "Микрочип",
			HealthBook:       "Медицинская книжка",
			Owner:            "Владелец",
			OwnerEmail:       "Email владельца",
			RecentWeights:    "Последние измерения веса",
			HeartRate:        "Частота дыхания",
			Alert:            " [оповещение]",
			CareReminders:    "Напоминания об уходе",
			Visits:           "Визиты (специалист)",
			ProConsulted:     "Специалист: ",
			Timeline:         "Хронология",
			Attachments:      "Вложения",
			HealthBookIncl:   "• medicinskaya-knizhka.pdf (входит в пакет)",
			NoAttachments:    "Вложений нет.",
			FooterGenerated:  "Создано %s UTC — petsFollow — непрерывность ветеринарной помощи.",
			FooterCreateAcct: "Создать профессиональный аккаунт: ",
			FooterCommercial: "Контакт менеджера по продажам: ",
		}
	default: // fr
		return pdfLabels{
			...
			HeartRate:        "Fréquence respiratoire",
			Alert:            " [alerte]",
