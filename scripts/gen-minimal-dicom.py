#!/usr/bin/env python3
"""Generate a minimal Explicit VR Little Endian Secondary Capture DICOM for Orthanc demo."""
...
def build_dicom(
    *,
    ...
    sop_instance = "1.2.826.0.1.3680043.8.498.1001.1"
    study_uid = "1.2.826.0.1.3680043.8.498.1001"
    series_uid = "1.2.826.0.1.3680043.8.498.1001.2"
    ...
    ds = b"".join(
        [
            ...
            _tag(0x0008, 0x0060, "CS", _ascii("OT")),
